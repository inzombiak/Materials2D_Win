...
static std::map<MaterialType, std::string> MATERIAL_TO_COLOR = {{MaterialType::Fire, "Red"}, {MaterialType::Ice, "Blue"}, {MaterialType::Default, "None"}};
...
void MaterialManager::LoadAllMaterials()
{
	...
	m_materials[MaterialType::Default] = std::make_shared<IMaterial>(IMaterial(MaterialType::Default));
}
